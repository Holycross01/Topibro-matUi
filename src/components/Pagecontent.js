    ...
    >
      ...
      >
        ...
        >
          ...
          >
           Becoming a professional, highly skilled, and trained web designer is all you need to succeed as an expert in web design, web, and mobile development
          </Typography>
          <Stack
          ...
          >
            ...
            <Button
              variant="contained"
              size="small"
              sx={{ minWidth: 'fit-content', bgcolor:'black', color:'white' }}
            >
              Start now
            </Button>
          </Stack>
